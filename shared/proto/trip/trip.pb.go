...
func (x *Driver) GetCarPlateNumber() string {
	if x != nil {
...
const file_trip_proto_rawDesc = "" +
	...
	"\bduration\x18\x03 \x01(\x01R\bduration\"F\n" +
	"\n" +
	"Coordinate\x12\x1a\n" +
	...
	"\x06driver\x18\x05 \x01(\v2\f.trip.DriverR\x06driver\x12!\n" +
	"\x05route\x18\x06 \x01(\v2\v.trip.RouteR\x05route\"|\n" +
	"\x06Driver\x12\x0e\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	3,  // 5: trip.Geometry.coordinates:type_name -> trip.Coordinate
	8,  // 6: trip.CreateTripResponse.trip:type_name -> trip.Trip
	5,  // 7: trip.Trip.selectedFare:type_name -> trip.RideFare
	9,  // 8: trip.Trip.driver:type_name -> trip.Driver
	2,  // 9: trip.Trip.route:type_name -> trip.Route
